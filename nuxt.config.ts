  ...
  app: {
    head: {
      ...
      link: [
        ...
        { rel: 'apple-touch-icon', href: '/fabsoon.png' }
      ],
      meta: [
        { name: 'description', content: 'You are invited to celebrate our wedding.' },
        { property: 'image', content: 'https://invitation.fabsoon.com/backgrounds/seo.jpg' },
        { property: 'url', content: 'https://invitation.fabsoon.com' },
        ...
        { property: 'og:image', content: 'https://invitation.fabsoon.com/backgrounds/seo.jpg' },
        { property: 'og:url', content: 'https://invitation.fabsoon.com' },
        ...
        { name: 'twitter:image', content: 'https://invitation.fabsoon.com/backgrounds/seo.jpg' }
      ]
    }
  },
  runtimeConfig: {
